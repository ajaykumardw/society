        ...
        <Grid container spacing={6}>
          <Grid size={{ xs: 12, md: 4 }}>
            <div className='flex flex-col items-center justify-center gap-y-4 bs-full text-center'>
              ...
              <Typography variant='h4'>Today&apos;s Free Modules</Typography>
              <Typography>
                We offers 284 Free Online modules from top tutors and companies to help you start or advance your career
                skills. Learn online for free and fast today!
              </Typography>
              <Button variant='contained'>Get Premium Modules</Button>
            </div>
          </Grid>
