...
const DepartmentDialog = ({ open, setOpen, data, fetchPermissionModule, nameData }) => {
    ...
    const submitData = async (VALUE) => {
        ...
        try {
            const response = await fetch(data ? `${URL}/company/department/${data?._id}` : `${URL}/company/department`,
                {
            ...
            if (response.ok) {
                ...
                toast.success(`Department ${data ? "updated" : "added"} successfully!`, {
