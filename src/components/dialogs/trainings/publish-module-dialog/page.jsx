...
const PublishTrainingDialog = ({ open, setOpen, type, moduleData, onUpdateStatusChangeState, cardItems }) => {
    ...
    const handleConfirmation = async (value) => {
        ...
        const endpoint = `admin/training/update/status/${moduleData._id}`;
...
export default PublishTrainingDialog
