...
import AmenityDialog from '@/components/dialogs/amenity-dialog/page'
...
const AmenityTable = ({ tableData, fetchZoneData }) => {
  ...
  const columns = useMemo(() => {
    ...
    baseColumns.splice(
      ...
      columnHelper.accessor("status", {
        ...
        cell: ({ row }) => (
          <Typography className="capitalize" color="text.primary">
            {row.original.status === 1 ? "Available" : "Unavailable"}
          </Typography>
        ),
      })
    )
    ...
    baseColumns.splice(
      ...
      columnHelper.accessor("Start_time", {
        ...
        cell: ({ row }) => (
          <Typography className="capitalize" color="text.primary">
            {formatTime12Hour(row.original.start_time)}
          </Typography>
        ),
      })
    );
    ...
    baseColumns.splice(
      ...
      columnHelper.accessor("end_time", {
        ...
        cell: ({ row }) => (
          <Typography className="capitalize" color="text.primary">
            {formatTime12Hour(row.original.end_time)}
          </Typography>
        ),
      })
    );
