...
export default function SLAReportDashboard() {
    ...
    const fetchData = async (currentFilters = filters) => {
        ...
        try {
            ...
            if (currentFilters.isSlaBreached) {
                params.append(
                    'isSlaBreached',
                    currentFilters.isSlaBreached
                )
            }
            ...
            const response = await fetch(
                `${API_URL}/company/sla/config/report${queryString
                    ? `?${queryString}`
                    : ''
                }`,
                {
            ...
            setData({
                ...
                slaBreachData: result?.data?.slaBreachData || []
            })
                                ...
                                paginatedComplaints.map(
                                    row => (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <Chip
                                                    label={row?.sla_breached ? "Breached" : "Not breached"}
                                                    color={row?.sla_breached ? "error" : "success"}
                                                    size="small"
                                                    variant="outlined"
                                                />
                                            </TableCell>
